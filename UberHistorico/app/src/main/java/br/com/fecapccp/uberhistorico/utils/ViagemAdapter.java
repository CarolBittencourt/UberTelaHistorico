...
import br.com.fecapccp.uberhistorico.DetalhesViagemActivity;
...
public class ViagemAdapter extends RecyclerView.Adapter<ViagemAdapter.ViagemViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViagemViewHolder holder, int position) {
        ...
        holder.btnConsultarDetalhes.setOnClickListener(v -> {
            ...
            //intent.putExtra("id", viagem.getId_viagem());
            ...
            intent.putExtra("passageiro", viagem.getPassageiro());
            //intent.putExtra("id_motorista", viagem.getId_motorista());
            //intent.putExtra("id_passageiro", viagem.getId_passageiro());
